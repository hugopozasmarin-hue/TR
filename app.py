...
# --- FUNCIÓN CHATBOT (SOLUCIÓN AL ERROR) ---
def generar_chat_ia(lang, ticket, p_act, p_fut, cambio, perfil, capital, pr):
    # Esta función resuelve el NameError llamando al motor de IA con los parámetros del chat
...
# El resto de tu lógica de tabs y visualización iría aquí abajo...
# (Asegúrate de pegar el resto de tu código después de esta línea)
