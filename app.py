...
# 2. DICCIONARIO MULTILINGÜE INTEGRAL 2026
languages = {
    "Español": {
...
with st.sidebar:
    ...
    st.markdown(f'<p class="field-title">{t["conf"]}</p>', unsafe_allow_html=True)
...
def hablar_con_ia_real(pregunta, lang, ticket, cambio, perfil):
    ...
    try:
        ...
        prompt = f"Eres InvestMind AI (Marzo 2026). Perfil: {perfil}, Activo: {ticket}, Tendencia: {cambio:.2f}%. Responde en {lang}."
...
st.caption("InvestMind AI Elite Platinum v17.0 | Badalona, 2026")
